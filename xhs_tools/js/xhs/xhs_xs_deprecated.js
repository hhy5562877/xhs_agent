function createHandler(name) {
    return {
        get(target, property, receiver) {
            ...
            // console.log("方法:", "get  ", "对象:", name, "  属性:", property,
            //     "  属性类型:", typeof property,
            //     "  属性值类型:", typeof target[property]);
            return target[property];
        },
        set(target, property, value, receiver) {
            // console.log("方法:", "set  ", "对象:", name, "  属性:", property,
            //     "  属性类型:", typeof property,
            //     "  属性值类型:", typeof target[property]);
...
function get_environment(proxy_array) {
    for (let i = 0; i < proxy_array.length; i++) {
        const proxyName = proxy_array[i];
        try {
            if (typeof eval(proxyName) !== 'undefined') {
                eval(`${proxyName} = new Proxy(${proxyName}, createHandler('${proxyName}'));`);
            }
        } catch (e) {
            eval(`${proxyName} = new Proxy({}, createHandler('${proxyName}'));`);
        }
    }
}
...
document = {
    createElement: function (tagName) {
        if (tagName === 'canvas') {
            return new Proxy(new convasElement(), createHandler('canvas'))
        } else {
            return {}
        }
    ...
    documentElement: new Proxy(new documentElement(), createHandler('documentElement')),
...
LocalStorage = class {
    constructor() {
        this.storage = {
            ...
            "xhs-pc-theme": "system",
            "b1": "",
            "sdt_source_storage_key": "{\"commonPatch\":[\"/fe_api/burdock/v2/note/post\",\"/api/sns/web/v1/comment/post\",\"/api/sns/web/v1/note/like\",\"/api/sns/web/v1/note/collect\",\"/api/sns/web/v1/user/follow\",\"/api/sns/web/v1/feed\",\"/api/sns/web/v1/login/activate\",\"/api/sns/web/v1/note/metrics_report\",\"/api/redcaptcha\",\"/api/store/jpd/main\",\"/phoenix/api/strategy/getAppStrategy\"],\"signUrl\":\"https://fe-static.xhscdn.com/as/v1/3e44/public/04b29480233f4def5c875875b6bdc3b1.js\",\"xhsTokenUrl\":\"https://fe-static.xhscdn.com/as/v1/3e44/public/bf7d4e32677698655a5cadc581fd09b3.js\",\"url\":\"https://fe-static.xhscdn.com/as/v1/3e44/public/0666f0acdeed38d4cd9084ade1739498.js\",\"reportUrl\":\"/api/sec/v1/shield/webprofile\",\"desVersion\":\"2\",\"validate\":true,\"signVersion\":\"1\",\"extraInfo\":{\"mnsTokenUrl\":\"https://fe-static.xhscdn.com/as/v1/3e44/public/11b080d07a42355a374e830a4a0dc392.js\"}}",
...
window.localStorage = new Proxy(new LocalStorage(), createHandler('localStorage'))

const proxy_array = ['window', 'document', 'location', 'history', 'screen'];
...
/**
 * 获取小红书X-s参数
 * @param {*} api 请求地址：/api/sns/web/v1/homefeed
 * @param {*} data 请求参数body对象：{"cursor_score":"","num":30,"refresh_type":1,"note_index":35,"unread_begin_note_id":"","unread_end_note_id":"","unread_note_count":0,"category":"homefeed_recommend","search_key":"","need_num":15,"image_formats":["jpg","webp","avif"],"need_filter_image":false}
...
function sign(api, data, cookies) {
    ...
    const b1 = ''
    const h = {
      "s0": 3,
      "s1": "",
      "x0": "1",
